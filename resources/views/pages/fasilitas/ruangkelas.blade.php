...
<div class="container py-5" style="min-height: 80vh;">
    ...
    <div class="text-center mb-5">
        <span class="badge bg-primary-subtle text-primary px-3 py-2 rounded-pill fw-semibold mb-2">Fasilitas Kampus</span>
        <h2 class="fw-bold text-dark mb-2">Daftar Ruang Kelas Teori</h2>
        <p class="text-muted mx-auto" style="max-width: 600px;">Ruang kelas yang nyaman, representatif, dan dilengkapi dengan sarana penunjang pembelajaran digital yang modern.</p>
                ...
                <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden card-hover transition-all">
                    ...
                    <div class="card-body p-4 d-flex flex-column">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <span class="text-primary fw-bold small text-uppercase tracking-wider"><i class="bi bi-hash"></i> {{ $item->kode_ruangan }}</span>
                        ...
                        <div class="mt-auto pt-3 border-top">
                            <h6 class="fw-bold text-dark small mb-2"><i class="bi bi-cpu text-info me-1"></i> Fasilitas:</h6>
        ...
        @empty
            <div class="col-12 text-center py-5">
                <div class="p-4 bg-white rounded-4 shadow-sm border inline-block" style="max-width: 400px; margin: 0 auto;">
                    ...
                    <p class="text-muted small mb-0">Belum ada data ruang kelas teori yang dimasukkan oleh admin.</p>
                </div>
            </div>
        @endforelse
    </div>
...
<style>
    /* Style Tambahan untuk Efek Cantik & Responsif */
    .card-hover:hover {
    ...
    /* Membatasi teks fasilitas maksimal 2 baris agar tinggi card tetap seimbang */
    .text-truncate-2 {
        display: -webkit-box;
