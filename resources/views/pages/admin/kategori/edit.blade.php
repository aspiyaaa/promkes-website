    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex flex-sm-row flex-column align-items-sm-center justify-content-between mb-4 pb-3 border-bottom gap-3">
                <div>
                    <h2 class="h4 mb-1 fw-bold text-dark lh-sm">Ubah Data Kategori</h2>
                    <p class="text-muted small mb-0">Perbarui informasi nama klasifikasi atau kelompok civitas akademik secara berkala di sini.</p>
                </div>
                <div>
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden" style="border-top: 4px solid #0d6efd !important;">
                <div class="card-header bg-white border-bottom py-3 px-4">
                    <div class="d-flex align-items-center gap-2">
                        <h6 class="mb-0 fw-bold text-dark">Form Perubahan Data Kategori</h6>
                    </div>
                </div>
                    ...
                    <form action="/kategori/{{ $kategori->id_kategori }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text text-muted small mt-2 opacity-75">
                                Mengubah nama kategori ini akan berdampak secara otomatis pada pengelompokan data civitas terkait yang menggunakannya.
                            </div>
                        </div>
